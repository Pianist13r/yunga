...
Минимум для курса — **Claude Code ≥ 2.1.260** (самая поздняя функция основного маршрута — `/reload-plugins` в Desktop). Прогон авторов — на 2.1.273. Источник — спецификация курса, §7.5; «DC\файл.md:строка» — снимок документации от 17.09.2026.
